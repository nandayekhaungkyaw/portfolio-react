  ...
  return (
    <div>
      ...
      <div className="px-6 pb-6">
       ...
       {responsive &&  <p className="py-1.5 px-3 me-2 mb-2 text-[8px] font-medium w-fit text-white focus:outline-none bg-red-600 rounded-full border border-gray-200 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600">Responsive </p>}
